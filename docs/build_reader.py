...
DOCS = [
    ...
    ("build/README.md",   "Build · Start",  "The website blueprint: the map, the bootstrap, the definition of done."),
    ("build/stack-and-hosting.md", "Build · Stack", "The stack restated; vendors at $25/month; CI, backups."),
    ("build/site-map.md", "Build · Site Map","Every surface of the site, who sees it, what it does."),
    ("build/auth-and-roles.md", "Build · Auth", "Magic links, the role model, playtest transparency."),
    ("build/database.md", "Build · Database","Every table, with DDL. The event store and the site around it."),
    ("build/engine-spec.md", "Build · Engine","The pure ruleset package; hashing, PRNG, integer policy, fixtures."),
    ("build/api-and-protocol.md", "Build · API", "HTTP surface and the owned WebSocket protocol, incl. reconnect."),
    ("build/authoring-pipeline.md", "Build · Authoring", "One pipeline, two doors. Kinds, validation, misfit classes."),
    ("build/rules-explainer.md", "Build · Explainer", "How Vectus Works — the nitty-gritty, on the real engine."),
    ("build/build-order.md", "Build · Order", "Milestones M0-M9 with acceptance criteria."),
    ("build/claude-md-template.md", "Build · CLAUDE.md", "The working rules for every session that writes code."),
