...
27. **Not every Verb is a vector.** Direct state changes — move, transfer, set, spend — have no magnitude to modify and meet no Guard. They pin to **X-100**, not through the R-region.
