...
- Listeners satisfied at the same Moment sort by semantic class, then `(layer, component_id, listener_id, target_entity_id)`. The class enumeration and the key's total-order completeness are open — `open-questions.md` Q3.8.
