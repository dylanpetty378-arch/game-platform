...
**Status, August 2026: Phase 0 and Phase 1 are closed.** Every blocking list is settled except **L6 · Verbs**, which is drafted (`Push` · `Set` · `Place` · `Repin` · `Link` · `Create` · `Decide`) and closes in Phase 2 against real content. **Next is Phase 2 · Paper — play it with index cards.** No Substrate code should depend on the Verb set being final.
